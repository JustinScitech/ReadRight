      ...
      <Box mt={6}>
        ...
        >
          <VStack spacing={7} align="start" maxWidth="50%">
            <Heading as="h2" size="lg" align="start">
              A free and productive way to enhance reading skills for dyslexics!
            </Heading>
            <Text textAlign="start" w= "full">
              Training with ReadRight is engaging, and studies indicate its
              effectiveness! Through concise, focused lessons, you'll accumulate
              points, progress through stages, and most importantly, enhance
              your reading capabilities.
            </Text>
          </VStack>
          <Image
        ...
        >
          ...
          <VStack spacing={2} align="end" maxWidth="50%">
            ...
            <Text textAlign="end" w="full">
              We harness a blend of evidence-based instructional techniques and
              captivating content to design modules that efficiently bolster
        ...
        >
          ...
          <VStack spacing={2} align="end" maxWidth="50%">
            ...
            <Text textAlign="end" w="full">
              Marrying the pinnacle of AI and pedagogical research, our sessions
              are adjusted to guide you through the ideal learning intensity and
              rhythm.
            </Text>
          </VStack>
        </Box>
